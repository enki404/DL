...
# Now model.output_shape is (None, input_length, out_dim), where `None` is the batch
# dimension.
...
Hist=model.fit(x_train, y_train, batch_size=32, epochs=4500,validation_data=(x_test,y_test))
...
plt.title('ANN Accuracy Graph',fontsize=15)
#plt.ylim([0.5,1])
...
plt.title('ANN Loss Graph',fontsize=15)
#plt.ylim([0.5,1])
...
ax.set_title('Confusion Matrix: Part3_ANN',fontsize = 36) 
...
cm1_disp.plot()
cm1_disp.ax_.set_title("Part3 ANN Confusion Matrix",fontsize=35)
