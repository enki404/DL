...
# filename= r"C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines2.csv"
...
df1 = pd.read_csv(r'C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines.csv')
df2 = pd.read_csv(r'C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines1.csv')
df3 = pd.read_csv(r'C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines2.csv')
df4 = pd.read_csv(r'C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines3.csv')
df5 = pd.read_csv(r'C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines4.csv')
df6 = pd.read_csv(r'C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines5.csv')
df7 = pd.read_csv(r'C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines6.csv',encoding = 'unicode_escape')
df8 = pd.read_csv(r'C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines7.csv')

BBC_DF = pd.concat([df1,df2,df3,df4,df5,df6,df7,df8], axis=0, ignore_index=True)
BBC_DF = BBC_DF.drop_duplicates(['Title'])
# maintain 3 classes have same data amount
BBC_DF = BBC_DF.drop(BBC_DF.index[1626:1682])
BBC_DF.reset_index(drop=True,inplace=True)
BBC_DF = BBC_DF.drop(BBC_DF.index[100:140])
BBC_DF.reset_index(drop=True,inplace=True)
unique, counts = np.unique(BBC_DF.LABEL, return_counts=True)
...
#word_list = str(ContentLIST).split(' ')

# and count the words
word_counts = Counter(ContentLIST)
...
stopwords = ['the', 'of', 'and', 'is','to','in','a','from','by','that', 'with', 'this', 'as', 'an', 'are',
             'its', 'at', 'for','it','more','on','has','more','it','be','was','than','up','just','here','after',
             'will','some','they','have','about','can','their','but','have','or','there','these','you','we',
             'how','who','what','his','he','been','after','around','could','which','de','no','over','la','into',
             'out','your','said','like','all','not','one','le','year','when','most','says'
             ]

# use a python list comprehension to remove the stopwords from words_list
words_without_stopwords = [ word for word in ContentLIST if word not in stopwords ]
...
##
Final_News_DF_Labeled.to_csv(r"C:\Users\enki0\Desktop\CSCI5922\Final_Exam\Labeled_News_Data_from_API_all.csv",index=False)
BBC_DF.to_csv(r"C:\Users\enki0\Desktop\CSCI5922\Final_Exam\NewHeadlines_all.csv",index=False)
